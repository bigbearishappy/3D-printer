...
/************************************************************************************************
name:		setExtruderAutoFanState()
function:	set the speed of a fan
			[in]	-	pin:the pin to control the fan
						state:the state of controlling the fan
			[out]	-	void
************************************************************************************************/
...
/***********************************************************************************************
name:		checkExtruderAutoFans()
function:	check to see which fan need to be turned on
			[in]	-	void
			[out]	-	void
***********************************************************************************************/
...
void disable_heater()
{
  for(int i=0;i<EXTRUDERS;i++)							//set all the extruder to the 0 degree
    setTargetHotend(0,i);
  setTargetBed(0);										//set the bed to the 0 degree
  #if defined(TEMP_0_PIN) && TEMP_0_PIN > -1
  ...
  #if defined(TEMP_BED_PIN) && TEMP_BED_PIN > -1		//the bed
